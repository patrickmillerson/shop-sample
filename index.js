...
function createCardObj(card_array_obj) {
    document.getElementById("my-cards").innerHTML = card_array_obj.join("");
    removeClass$Spinner();
}
...
function getProductValues(e) {
    ...
    console.log(card_product_array);
}
